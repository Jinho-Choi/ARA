        ...
        <div class="col-md-12">
            <div class="well well-sm">
                <form action ="logout.mem" class="form-horizontal" method="post">
                    <fieldset>
                        <legend class="text-center header" STYLE ="color:black; font-weight:bold; font-family: 맑은고딕" >회원 관리</legend>

                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                            <div class="col-md-8">
                                 <span STYLE ="font-size: 20px; font-weight:bold; font-color: #4169E1; font-family: 맑은고딕"> ${loginUser.m_name }</span> <font style="font-family: 맑은고딕">님</font><br>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <input type="button" class="btn btn-primary btn-lg" style =  "margin-bottom: 5px; background-color: #424242; font-family: 맑은고딕" value = "회원 목록보기" onclick = "winMemberList() ">
                                <button type="submit" class="btn btn-primary btn-lg" style =  "margin-bottom: 5px; background-color: #424242; font-family: 맑은고딕">로그아웃</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
